...
export default function ContactUs() {
  return (
    <div className=" max-w-6xl mx-auto">
      <section
        id="ContactUs"
        class="min-h-screen bg-gradient-to-r from-blue-50 via-blue-100 to-blue-200 p-5 mb-10 rounded-lg mx-4 "
      >
            ...
            <div class="text-black lg:w-1/2 lg:mx-6">
              ...
              <div class="mt-6 md:mt-8">
                ...
                <div class="flex mt-4 -mx-1.5 ">
                  <a
                    class="mx-1.5 text-black transition-colors duration-300 transform hover:text-blue-500"
                    href="#"
                  >
                    <svg
                  ...
                  <a
                    class="mx-1.5 text-black transition-colors duration-300 transform hover:text-blue-500"
                    href="https://www.instagram.com/flexi.geeks"
                  >
                    <svg
                      class="w-8 h-8"
                      viewBox="0 0 24 24"
